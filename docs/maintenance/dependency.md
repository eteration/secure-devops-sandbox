...
`react-boilerplate` does not use "^", "~", etc., and these should be removed from `package.json`, if present. See [#598](https://github.com/eteration/secure-devops-sandbox/issues/598) for more details.
