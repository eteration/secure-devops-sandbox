...
Please refer to to issue [#2566](https://github.com/eteration/secure-devops-sandbox/issues/2566) for more explanation.
...
```yaml
# Check https://github.com/eteration/secure-devops-sandbox/issues/2566 for details
option_settings:
