...
The [issue tracker](https://github.com/eteration/secure-devops-sandbox/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git remote add upstream https://github.com/eteration/secure-devops-sandbox.git
    ```
